...
- No FullCalendar, dnd-kit, Radix, or self-reported timing. Local tasks are edited on 任务, not on 今日.
...
- Plan lives on the local 任务 page. Slot snapshots pin unfinished timed tasks. Judgement must work with an empty board.
